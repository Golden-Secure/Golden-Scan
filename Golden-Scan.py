...
class VirusTotalScannerGUI:
    ...
    def create_status_bar(self):
        ...
        version_label = tk.Label(
            status_bar,
            text="Golden-Scan v5.0 Premium Edition",
            bg=self.colors["bg_secondary"],
            fg=self.colors["text_muted"],
            font=("Segoe UI", 8)
        )
...
<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            ...
            <div class="footer"><p>Report generated by Professional VirusTotal Scanner</p><p style="margin-top: 8px; font-size: 12px; color: var(--text-tertiary);">© 2024 Security Analysis Tools</p></div>
        </div>
